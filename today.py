...
if __name__ == '__main__':
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 2, 22))  # TODO: replace YYYY, M, D with your birth year, month, day
    ...
    svg_overwrite('github_readme.svg', age_data, commit_data, star_data, repo_data, contrib_data, follower_data, total_loc[:-1])
